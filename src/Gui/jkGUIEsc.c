...
#ifdef PLATFORM_VR
    // Altered: keep "Return to Game" visible in VR. The Y/menu shortcut still triggers
    // this escape target, but the explicit button is useful and avoids a dead-end menu.
    jkGuiEsc_aElements[JKGUIESC_ELMT_RETURNTOGAME].bIsVisible = 1;
#endif
