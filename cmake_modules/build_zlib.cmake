...
set(ZLIB_CMAKE_MAKE_PROGRAM_ARG "")
if(CMAKE_MAKE_PROGRAM)
    set(ZLIB_CMAKE_MAKE_PROGRAM_ARG "-DCMAKE_MAKE_PROGRAM=${CMAKE_MAKE_PROGRAM}")
endif()

set(ZLIB_ANDROID_ABI_ARG "")
if(ANDROID_ABI)
    set(ZLIB_ANDROID_ABI_ARG "-DANDROID_ABI=${ANDROID_ABI}")
endif()
...
ExternalProject_Add(
    ...
    CMAKE_ARGS          --install-prefix ${ZLIB_INSTALL_DIR}
                        ...
                        ${ZLIB_ANDROID_ABI_ARG}
                        ${ZLIB_CMAKE_MAKE_PROGRAM_ARG}
